...
// ? local
const { getLeaves, getLeaveByUserId } = require("./getLeave");
const addLeave = require("./addLeave");
const deleteLeave = require("./deleteLeave");
const editLeave = require("./editLeave");

router.get("/", getLeaves);

router.get("/get-leave/:userId", getLeaveByUserId);
 ...
 * @params leaveId
 */
router.put("/leave/:id", editLeave);

router.patch("/leave/:id", editLeave);
